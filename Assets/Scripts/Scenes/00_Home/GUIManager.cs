	...
	public class GUIManager
	{
        ...
        public static GameObject UIRoot
        {
            get
            {
                ...
                {
                    mPrivateUIRoot = Object.Instantiate(Resources.Load<GameObject>("Prefab/UIRoot"));
        ...
        public static GameObject LoadPanel(string filePath, string panelName)
        {
            var panelPrefab = Resources.Load<GameObject>(filePath + "/" + panelName);
            var panelObj = Object.Instantiate(panelPrefab);
            panelObj.name = panelName;

            mPanelDict.Add(panelName, panelObj);
            panelObj.transform.SetParent(UIRoot.transform);
